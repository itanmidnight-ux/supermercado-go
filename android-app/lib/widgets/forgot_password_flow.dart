...
class _ForgotPasswordModalState extends State<_ForgotPasswordModal> {
  ...
  Future<void> _confirmReset() async {
    ...
    try {
      await ApiService.resetPassword(
          _emailCtrl.text.trim(), code, _pwCtrl.text);
      if (mounted)
        setState(() {
          _step = _Step.done;
          _loading = false;
            ...
            children: [
              ...
              Text(
                switch (_step) {
                  ...
                  _Step.code =>
                    'Enviamos un código de 6 dígitos a ${_emailCtrl.text.trim()}. Vence en 5 minutos.',
                  _Step.done =>
              ...
              if (_step == _Step.code)
                Padding(
                  ...
                  child: Center(
                    ...
                    child: const Text('¿No te llegó? Volver a enviar',
  ...
  List<Widget> _buildCodeStep(ColorScheme scheme) => [
        TextField(
          ...
          textAlign: TextAlign.center,
          style: const TextStyle(
              fontSize: 24, letterSpacing: 10, fontWeight: FontWeight.w700),
          decoration: InputDecoration(
            counterText: '',
            hintText: '000000',
            filled: true,
